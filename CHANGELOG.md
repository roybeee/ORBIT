## 2026-09-26 · 결재안을 펼치지 않고 회의 단위로 한꺼번에 반려합니다

- 결재함의 회의 묶음마다 제목 옆에 체크박스가 생겼습니다. 접혀 있는 회의(**결재안 펼치기 · N건**)도 펼치지 않고 고를 수 있습니다.
- 회의 묶음 위에 **모든 회의 선택**과 **선택한 회의 N개 · 결재안 M건 반려**가 있습니다. 두 번 눌러야 반려되고, 고른 회의의 대기 중 결재안이 한 번에 반려됩니다. 이미 승인·반려된 카드는 건너뜁니다.
- 회의를 하나라도 고르면 반려 막대가 화면 위에 붙어 따라옵니다. 아래쪽 접힌 회의를 골라도 맨 위로 올라가지 않고 바로 반려할 수 있습니다.
- 반려는 카드마다 요청을 보내지 않고 서버 한 번(500건 단위)으로 처리합니다. 회의 안의 **선택하지 않은 N건 반려**도 같은 방식이라 빨라졌습니다. 새 프로젝트 제안을 반려하면 같은 회의의 남은 카드는 전처럼 회의록 프로젝트로 옮겨집니다.
