...
const tables=['orbit_workspaces','orbit_workspace_chunks','orbit_workspace_projects','orbit_data_trash','orbit_note_revisions','orbit_reviews','orbit_conversations','orbit_agent_turns','orbit_agent_actions','orbit_agent_orders','orbit_order_reviews','orbit_order_reads','orbit_attachments','orbit_sound_state','orbit_calendar_settings','orbit_daily_runs','orbit_aside_jobs','orbit_source_status','orbit_calendar_exports','orbit_daily_runtime','orbit_chief_jobs','orbit_calendar_cache','orbit_activity_sessions','orbit_activity_messages','orbit_brief_runs'] as const;
