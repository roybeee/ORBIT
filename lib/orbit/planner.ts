...
export function generateProposal(tasks:Task[],events:CalendarEvent[],date:string,energy:Proposal['energy']='normal',previous?:Proposal,preferences?:Preferences):Proposal{
