...
export interface BriefEvidence {id:string;kind:'project'|'task'|'note'|'review'|'event'|'conversation'|'decision'|'delegation'|'plaud'|'memory'|'goal';recordId:string;title:string;date?:string;revision?:number;excerpt?:string}
