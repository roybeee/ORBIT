...
export interface WorkspaceData {schemaVersion:2;projects:Project[];tasks:Task[];notes:Note[];events:CalendarEvent[];proposals:Proposal[];reviews:DailyReview[];preferences:Preferences}
