...
export interface AgentTurn {id:string;input:string;status:'running'|'completed'|'failed';text:string;error?:string;progress?:string;sources:{title:string;label:string}[];createdAt:string}
