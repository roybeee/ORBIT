...
const readSchema=z.object({tool:z.enum(['workspace_search','read_note','plaud_tools','plaud_read','google_calendar_read','conversation_search']),arguments:z.record(z.unknown())}).strict();
