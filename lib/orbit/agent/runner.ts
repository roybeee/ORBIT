...
- conversation_search: {query:string}. Searches the owner's saved Orbit conversations across threads. User utterances and previous AI answers are separate; previous AI content is not proof about the user.
