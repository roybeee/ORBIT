...
node --experimental-strip-types --test tests/discord.test.mjs tests/data-manager.test.mjs tests/order-research.test.mjs tests/orders.test.mjs tests/agent.test.mjs tests/calendar-delete.test.mjs tests/calendar-outbox.test.mjs tests/calendar-live.test.mjs tests/sound.test.mjs tests/aside.test.mjs tests/aside-bridge.test.mjs tests/automation.test.mjs tests/phase1.test.mjs tests/phase2.test.mjs tests/phase3.test.mjs tests/phase4.test.mjs tests/phase5.test.mjs tests/workflow-activity.test.mjs tests/reliability.test.mjs
