...
- 회의록 결재 프로젝트 선택(기존 연결·새 이름 생성)과 프로젝트 합치기(`feat/meeting-project-picker`)가 이 PR로 `merged` 예정이다. 게시는 머지 후 따로 기록한다.
...
- 수동 구역: 2026-09-25T01:20Z (Claude, 회의록 프로젝트 선택·프로젝트 합치기 반영)
